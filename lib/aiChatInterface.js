...
class AIChatInterface {
  ...
  syncChapterSelection() {
    ...
    const fallback = this.isValidChapterNumber(storedValue) ? storedValue : 1;

    localStorage.setItem('selectedNumber', fallback.toString());
    this.updateChapterQueryParam(fallback);
  }
