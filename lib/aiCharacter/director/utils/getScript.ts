...
const templates = [
  {
    index: 0,
    script: ['老師：哈囉', '學生：哈囉～老師好。'],
  },
  {
    index: 1,
    script: [
      '老師：嗨，很高興見到你！想先了解，你平常大部分是在哪些場合需要用到{subject}呢？',
      '學生：我是一名{job}，平常在{usage_scenario_tag}需要用到{subject}。',
  ...
  },
  {
    ...
    script: [
      ...
      '學生：我是一名{job}，平常在{usage_scenario_tag}需要用到{subject}。一開始是因為{extrinsic_motivation}。',
  ...
  },
  {
    ...
    script: [
      ...
      '學生：我是一名{job}，平常在{usage_scenario_tag}需要用{subject}。',
  ...
  },
  {
    ...
    script: [
      ...
      '學生：我是一名{job}，平常在{usage_scenario_tag}需要用到{subject}。一開始是因為{extrinsic_motivation}，後來也希望{intrinsic_motivation}。',
      '老師：了解～所以不只是眼前的需求，也希望有更長遠的改變。以我看，你大概在{current_performance}。你自己覺得呢？哪些地方比較有把握？哪些地方比較困難？',
      '學生：對啊，我覺得{strengths}還可以，但{biggest_gap}常常讓我卡住，尤其在{usage_context}很容易緊張。以前{past_experience}{learning_blindspots}，所以一直沒改善。我希望短期能先往{target_level}靠近，做到{short_term_goal}，再慢慢往{long_term_goal}，最後能{long_term_outcome}。',
    ],
  },
];
